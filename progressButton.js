...
;( function( window ) {
	...
	ProgressButton.prototype._initEvents = function() {
		...
		this.button.addEventListener( 'click', function() {
			...
			document.getElementById("mainText").textContent="Tikrinamos merginų kojos";
	...
	ProgressButton.prototype._stop = function( status ) {
		var self = this;
				document.getElementById("mainText").textContent="Patikrinti, galbūt jau nupirko";
		...
		setTimeout( function() {
			...
			if( typeof status === 'number' ) {
				...
				var response = 'response' + getRandomInt();
				classie.add( self.button, response);
				// after options.statusTime remove status
				setTimeout( function() {
					classie.remove( self.button, statusClass );
					classie.remove( self.button, response );
					self._enable();
